...
// (7) import routes
const listBukuRoutes = require('./routes/listbuku')
const listPinjamRoutes = require('./routes/listpinjam')

// (8) app.use (mendaftarkan middleware baru ke Express)
app.use('/listbuku', listBukuRoutes)
app.use('/listpinjam', listPinjamRoutes)
app.get('/', (req, res) => {
    res.send("Selamat Datang di BETA API")
})
